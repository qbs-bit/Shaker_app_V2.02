// Note: RequestServiceForm component...!
...
const RequestServiceForm = ({ navigation, route }) => {
    ...
    const submitRequestServiceForm = () => {
        ...
        // }
            ...
            requestServiceFormFunc(salesInquiryForm);
            clearAll();
        }
    }

    // Note: Function to call API and send data to the API...!
    const requestServiceFormFunc = async (formData) => {
        console.log(formData, 'Request and Service data recieved in action!');

        let userPhoneNum = availableUser.MobilePhoneNo;
        let api = `https://crm.shaker.com.sa/api/customers/requestServices/?uniqueIdentifier=${userPhoneNum}`
        ...
        try {
            ...
            if (response.data.message === "Added Successfully") {
                ...
                setTimeout(() => {
                    navigation.navigate('Service Num', { notificationParams: requiredData });
                }, 2000);
            }
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.mainContainer}>
                        ...
                        <View style={styles.mainBtnContainer}>
                            <TouchableOpacity style={styles.btnContainer} onPress={submitRequestServiceForm}>
