...
const RaiseComplaintForm = ({ navigation, route }) => {
    ...
    const submitRaiseComplainForm = () => {
        ...
        if (brandValue === "") {
            ...
            // console.log(raiseComplaintForm);
            raiseComplainFormFunc(raiseComplaintForm);
            clearAll();
        }
    }

    // Note: Function to call API and send data to the API...!
    const raiseComplainFormFunc = async (formData) => {
        console.log(formData);
        let userPhoneNum = availableUser.MobilePhoneNo;

        let api = `https://crm.shaker.com.sa/api/customers/raisecomplaint?uniqueIdentifier=${userPhoneNum}`;
        ...
        try {
            ...
            if (response.data.message === "Added Successfully") {
                ...
                setTimeout(() => {
                    navigation.navigate('Complain', { notificationParams: requiredData });
                }, 2000);
            }
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.mainContainer}>
                        ...
                        <View style={styles.mainBtnContainer}>
                            <TouchableOpacity style={styles.btnContainer} onPress={submitRaiseComplainForm}>
