// Note: SalesInquiryForm component...!
...
const SalesInquiryForm = ({ navigation, route }) => {
    ...
    const submitSalesInquiryForm = () => {
        ...
        // }
            ...
            salesInquiryFormFunc(salesInquiryForm);
            clearAll();
        }
    }

    // Note: Function to call API and send data to the API...!
    const salesInquiryFormFunc = async (formData) => {
        console.log(formData, 'Sales and inquiry data recieved in action!');

        let userPhoneNum = availableUser.MobilePhoneNo;
        let api = `https://crm.shaker.com.sa/api/inquiry/AddNewInquiry/?uniqueIdentifier=${userPhoneNum}`;
        ...
        try {
            ...
            if (response.data.message === "Added Successfully") {
                showToast("Thank You!\nSales and Inquiry form has been submitted successfully!");

                setTimeout(() => {
                    navigation.navigate('Sales Num', { notificationParams: requiredData });
                }, 2000);
            }
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.mainContainer}>
                        ...
                        <View style={styles.mainBtnContainer}>
                            <TouchableOpacity style={styles.btnContainer} onPress={submitSalesInquiryForm}>
